...
export default function StatusBadge({ status, className = "" }: StatusBadgeProps) {
  const getStatusClass = (s: string) => {
    ...
    if (lower === "accepted" || lower === "ac" || lower === "public" || lower === "active") {
      return "pill pill-green";
    }
    if (lower === "pending" || lower === "queued" || lower === "running") {
      return "pill pill-yellow";
    }
    if (lower === "wrong answer" || lower === "wa" || lower === "rejected" || lower === "private" || lower === "closed") {
